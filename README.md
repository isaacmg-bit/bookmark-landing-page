...
**Bookmark landing page** built with **HTML** and **CSS**, designed with a **responsive** and **mobile-first** approach.
...
This project started as a web layout practice with the goal of recreating a **modern landing page** using only HTML and CSS.  
